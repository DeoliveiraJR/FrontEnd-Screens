...
class ScreenSales extends React.Component {
  ...
  handleClick() {
    ...
    console.log("----------------");
    const { date, codVenda, codProduto, quantidade, method, valorVenda } =
      this.state;
        ...
        <div className="container-form">
          <div className="block-form">
            <form className="main-form">
              ...
              <label htmlFor="method" className="main-label2">
                Método/Pgto:
                <select
        ...
        <div className="container-table-products">
          <table className="main-table">
            <tr className="main-tr">
              <th className="celulasColumnsValues">Código da venda</th>
              <th className="celulasColumnsValues">CODIGO PRODUTO</th>
              <th className="celulasColumnsValues">QTDE</th>
              <th className="celulasColumnsText">Método/Pgto</th>
            ...
            {!sales ? (
              ...
              sales.map((sale, index) => (
                <tr key={index} className="main-td">
                  <td className="celulasRow">{sale.codVenda}</td>
                  <td className="celulasRow">{sale.codProduto}</td>
                  <td className="celulasRow">{sale.quantidade}</td>
                  <td className="celulasRow">{sale.method}</td>
